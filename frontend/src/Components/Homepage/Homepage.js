...
const Homepage = ({ showModal, setShowModal }) => {
  ...
  return (
    <div className="Homepage-container">
      ...
      {alert.message && (
        <div className="mt-3">
          <AlertBox message={alert.message} show={alert.show} />
        </div>
      )}
